/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/trend-engine/wrangler.jsonc --env-file=workers/trend-engine/.dev.vars.example workers/trend-engine/worker-configuration.d.ts` (hash: 2ad49122f2a1bcf215646289d4dd81ab)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AUTOPILOT_MODE" | "SOURCE_HOST_ALLOWLIST">> {}
}
