/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/trend-engine/wrangler.jsonc --env-file=workers/trend-engine/.dev.vars.example workers/trend-engine/worker-configuration.d.ts` (hash: 5e331c1d034846673d28f396b2a35606)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AUTOPILOT_MODE" | "SOURCE_HOST_ALLOWLIST" | "OPENAI_RESEARCH_MODEL">> {}
}
