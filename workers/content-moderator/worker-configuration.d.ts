/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/content-moderator/wrangler.jsonc --env-file=workers/content-moderator/.dev.vars.example workers/content-moderator/worker-configuration.d.ts` (hash: 4bde0c72d58151ca524f0c12817894a5)
// Runtime types generated with workerd@1.20260710.1 2026-07-13 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	SUPABASE_URL: "https://hsrfyiazliydrpgtwwul.supabase.co";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "MODERATION_FROM_EMAIL" | "MODERATION_FROM_NAME" | "MODERATION_TO_EMAIL">> {}
}
